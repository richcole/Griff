...
gtk_dial_get_type ()
{
  ...
  if (!dial_type)
	...
	(GInstanceInitFunc) gtk_dial_init,
      ...
      dial_type = g_type_register_static(
        GTK_TYPE_WIDGET, "GtkDial", &dial_info, (GTypeFlags)0
      );
    }
...
gtk_dial_new (GtkAdjustment *adjustment)
{
  ...
  dial = GTK_DIAL(g_object_new(gtk_dial_get_type (), NULL));
			...
			GtkAllocation *allocation)
{
  ...
  dial->radius = (int) (MIN (allocation->width, allocation->height) * 0.45);
		       ...
		       GdkEventButton *event )
{
  ...
  dx = (int) ( event->x - widget->allocation.width / 2 );
  dy = (int) ( widget->allocation.height / 2 - event->y );
                        ...
                        GdkEventMotion *event )
{
  ...
  if (dial->button != 0) {
    ...
    switch (dial->button) {
    case 1:
      mask = (int) ( GDK_BUTTON1_MASK );
      break;
    case 2:
      mask = (int) ( GDK_BUTTON2_MASK );
      break;
    case 3:
      mask = (int) ( GDK_BUTTON3_MASK );
      break;
    default:
      mask = (int) ( 0 );
      break;
...
gtk_dial_update_mouse( GtkDial *dial, gint x, gint y )
{
  ...
  dial->adjustment->value = (int) 
    ( 
      dial->adjustment->lower + (7.*M_PI/6 - dial->angle) *
  ...
  if (dial->adjustment->value != old_value) {
    if (dial->policy == GTK_UPDATE_CONTINUOUS) {
      ...
      if (dial->policy == GTK_UPDATE_DELAYED) {
          ...
          ( 
            g_timeout_add(
              SCROLL_DELAY_LENGTH, (GtkFunction) gtk_dial_timer,
					   (gpointer) dial) 
          );
	    }
    }
...
gtk_dial_update (GtkDial *dial)
{
  ...
  new_value = (int) ( dial->adjustment->value );
  
  if (new_value < dial->adjustment->lower)
    new_value = (int) ( dial->adjustment->lower );

  if (new_value > dial->adjustment->upper)
    new_value = (int) ( dial->adjustment->upper );

  if (new_value != dial->adjustment->value)
    {
      dial->adjustment->value = (int) ( new_value );
      g_signal_emit_by_name (GTK_OBJECT (dial->adjustment), "value_changed");
    }

  dial->angle = (int) ( 7.*M_PI/6. - (new_value - dial->adjustment->lower) * 4.*M_PI/3. /
			      ...
			      gpointer       data)
{
  ...
  if ((dial->old_value != adjustment->value) ||
      ...
      (dial->old_upper != adjustment->upper))
    {
      ...
      dial->old_value = (int) ( adjustment->value );
      dial->old_lower = (int) ( adjustment->lower );
      dial->old_upper = (int) ( adjustment->upper );
    }
}
