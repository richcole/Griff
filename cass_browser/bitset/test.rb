...
class TC_BitSet < Test::Unit::TestCase
  ...
  def test_subseteq
    ...
    a = BitSet.from_bin("0101000")
    b = BitSet.from_bin("1111100000")
    x = a.subseteq b
    assert_equal(1, x)
    
    a = BitSet.from_bin("0101000000")
    b = BitSet.from_bin("1111")
    x = a.subseteq b
    assert_equal(1, x)
    
    a = BitSet.from_bin("0101000000")
    b = BitSet.from_bin("1011")
    x = a.subseteq b
    assert_equal(0, x)
    
    a = BitSet.from_bin("00000000000001")
    b = BitSet.from_bin("00000000000001")
    x = a.subseteq b
    assert_equal(1, x)
    
    a = BitSet.from_bin("1")
    b = BitSet.from_bin("100000001")
    x = a.subseteq b
    assert_equal(1, x)
